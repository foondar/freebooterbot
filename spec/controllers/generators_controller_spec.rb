...
RSpec.describe GeneratorsController, type: :controller do
  ...
  # GeneratorsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Generator" do
        expect {
          post :create, params: {generator: valid_attributes}, session: valid_session
        }.to change(Generator, :count).by(1)
      end

      it "redirects to the created generator" do
        post :create, params: {generator: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Generator.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {generator: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested generator" do
        generator = Generator.create! valid_attributes
        put :update, params: {id: generator.to_param, generator: new_attributes}, session: valid_session
        generator.reload
      ...
      it "redirects to the generator" do
        generator = Generator.create! valid_attributes
        put :update, params: {id: generator.to_param, generator: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        generator = Generator.create! valid_attributes
        put :update, params: {id: generator.to_param, generator: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
